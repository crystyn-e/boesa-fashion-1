...
export default function Home({
    ...
    // Icon flat untuk kategori (Heroicons)
    const categoryIcons = {
        Jas: <UserIcon className="w-8 h-8" />,
        Gaun: <FaceSmileIcon className="w-8 h-8" />,
        Sepatu: <ShoppingBagIcon className="w-8 h-8" />,
        Aksesoris: <SparklesIcon className="w-8 h-8" />,
        Kostum: <DevicePhoneMobileIcon className="w-8 h-8" />,
        Dasi: <TagIcon className="w-8 h-8" />,
    };
    ...
    const categories =
        initialCategories?.length > 0
            ...
            : [
                  { name: "Jas", count: 45 },
                  { name: "Gaun", count: 38 },
                  { name: "Sepatu", count: 52 },
                  { name: "Aksesoris", count: 67 },
                  { name: "Kostum", count: 23 },
                  { name: "Dasi", count: 41 },
              ];
    ...
    return (
        <PublicLayout>
            <div className="space-y-16 md:space-y-24">
                ...
                {/* ========== CATEGORIES SECTION (DENGAN FLAT ICON) ========== */}
                        ...
                        {categories.map((cat, idx) => (
                            ...
                            >
                                ...
                                <div className="p-6 text-center">
                                    <div className="flex justify-center mb-3 text-[#C5A059] group-hover:text-[#0A192F] transition-colors">
